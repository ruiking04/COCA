...
from models.DeepSVDD.base import BaseADDataset
from models.DeepSVDD.networks import build_network, build_autoencoder
from models.DeepSVDD.optim.deepSVDD_trainer import DeepSVDDTrainer
from models.DeepSVDD.optim.ae_trainer import AETrainer


class DeepSVDDModule(object):
    ...
    def __init__(self, config, objective: str = 'one-class', nu: float = 0.1):
    ...
    def test(self, dataset: BaseADDataset, device: str = 'cuda', n_jobs_dataloader: int = 0):
        ...
        return self.trainer.test_scores
    ...
    def pretrain(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
        ...
        self.ae_net = build_autoencoder(self.config)
